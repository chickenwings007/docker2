...
<div class="posts infinite-scroll masonry" data-paginate="infinite_scroll" data-layout="masonry" data-masonry-column="3">
<div class="posts-wrap infinite-scroll-wrap masonry-wrap posts-layout-masonry row" style="margin-left:250px;">
<article class="infinite-scroll-item masonry-item col-md-4 col-sm-6" style="width:68%;">
...
<div class="entry-content" style=" margin-left:250px;"></div>
...
<div class="readmore-link text-right"> 
<select class="form-control" name="status">
<option value="">Select Status</option>
<option value="switch">Switch</option>
<option value="completed">Completed</option>
</select><br>
<textarea id="txtremark" name="txtremark" placeholder="Reason To Switch" class="form-control textarea"></textarea><br>
