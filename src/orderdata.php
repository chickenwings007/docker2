...
<?php
	if(isset($_REQUEST['btnsubmit']))
	{
		...
		{
			$id= mysql_insert_id();
			echo"<script>window.location ='userverifyregi.php?id=$id';</script>";
		}
		else
		{
			echo "Not Registered";
...
<div class="container">
<div class="row">
<h1 align="center" style="color:#57bb8a;"><i class="elegant_icon_ribbon_alt"></i> <strong>Sign Up</strong></h1>
...
<button type="submit" name="btnsubmit" id="btnsubmit" class="btn btn-primary btn-block btn-sm btn-style-outlined btn-effect-bg-right"><span>Register</span></button>
</div>
</form>
</div>
