...
<?php 
	$qry="select * from tbl_employee where emp_id = '". $_SESSION['eid'] ."'";
	$rs = mysql_query($qry);
...
<img  src="<?php echo "admin/images/employee/" . $r['emp_img']; ?>" alt=""/>
</a>
</div>
...
<a title="Ticket Date">
<span class="date" style="font-size:16px;color:#FFFFFF;background-color:#57bb8a"><?php echo "<strong>Block : </strong>" . $r["emp_block"] ?></span>
</a>
...
<p class="col-md-3">
<strong><i class="elegant_icon_mobile"></i>&nbsp;Contact : </strong><?php echo $r["emp_contact"]; ?><br>
<br>
<strong><i class="elegant_icon_mail_alt"></i>&nbsp;Email : </strong><?php echo $r["emp_email"]; ?><br>
<br>
<strong><i class="elegant_icon_house"></i>&nbsp;Address : </strong><?php echo $r["emp_address"]; ?><br>
<br>
...
<td><input type="text" name="txtname" id="txtname" value="<?php echo $r['emp_name']; ?>"></td>
</tr>

<tr>
<td><i class="elegant_icon_mail"></i> <strong>Email :</strong> </td>
<td><input type="text" name="txtemail" id="txtemail" value="<?php echo $r['emp_email']; ?>"></td>
</tr>

<tr>
<td><i class="elegant_icon_house"></i> <strong>Address :</strong> </td>
<td><input type="text" name="txtadd" id="txtadd" value="<?php echo $r['emp_address']; ?>"></td>
</tr>
...
if(isset($_REQUEST['btnup']))
		{
			$sql=mysql_query("update tbl_employee set emp_name='".$_REQUEST['txtname']."',emp_email='".$_REQUEST['txtemail']."', emp_address='".$_REQUEST['txtadd']."' where emp_id='". $_SESSION['eid'] ."'");
			if($sql)
			{
				echo "<script>window.location = 'empprofile.php'; </script>";
			}
			else
			{
