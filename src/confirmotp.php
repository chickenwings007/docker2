...
<i class="elegant_icon_lock"></i>&nbsp;<strong>Enter OTP : Valid Throgh <?php $t=time(); echo date("Y-m-d",$t); ?></strong>
...
if(isset($_REQUEST['btnotp']))
{
	...
	if(mysql_num_rows($sql)>0)
	{
		...
		if($newotp == $_REQUEST['txtotp'])
		{
			...
			echo "<script>window.location='forgotpassword.php?cp=$userid';</script>";
		}
	}
	else
	{
