...
//				}
	...
	$(document).ready(function(){
		var wp_version = $("<div />").addClass("wp__version").css({
			'bottom': '-70px',
		    'opacity': '1',
		    'position': 'fixed',
		    'right': '100px',
			...
			$("<a />").attr('target','_blank').attr("href", "http://themeforest.net/item/airslice-creative-responsive-wordpress-theme/9830339?ref=SiteSao").append(
				
			)
		);

		$("body").append(wp_version);
		wp_version.delay(2000).animate({ bottom: "0" }, 300);
