...
<thead>
<tr>
<th class="product-name" style="text-align:center;">Client Name</th>
...
<?php
	if($row['status']=="completed" | $row['status']=="switch")
	{
?>
...
<?php		
	...
	{
?>
	<a href="status.php?sid=<?php echo $converter->encode($row['ticket_id']); ?>"style="color:#57bb8a"><?php echo ucwords($row['status']); ?></a>
<?php 
	}
?>	
...
<td class="product-name text-center"><?php echo $row['address']; ?></td>
<td class="product-name text-center"><?php echo $row['pincode']; ?></td>
<td class="product-name text-center"><?php echo $row['contact']; ?></td>
</tr>
<?php 
}
?>
