       ...
       <div class="row" id="row">
        <div class="col-md-3 col-sm-6 col-xs-12 nopad-right">
            <div class="dashboard-stats">
                <div class="left">
                    <h3 class="flatBluec counter" data-to="<?php $user=mysql_query("select * from tbl_user");
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 nopad-right">
            <div class="dashboard-stats">
                <div class="left">
                    <h3 class="flatOrangec counter" data-to="<?php $user=mysql_query("select * from tbl_ticket");
					 echo mysql_num_rows($user);
					 ?>" data-speed="4000"></h3>
                    <h4>Total Tickets</h4>
                </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 nopad-right">
            <div class="dashboard-stats">
                <div class="left">
                    <h3 class="flatRedc counter" data-to="<?php $user=mysql_query("select * from tbl_ticket where status !='completed'");
					 echo mysql_num_rows($user);
					 ?>" data-speed="4000"></h3>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 nopad-right">
            <div class="dashboard-stats">
                <div class="left">
                    <h3 class="flatGreenc counter" data-to="<?php $user=mysql_query("select * from tbl_ticket where status='completed'");
					 echo mysql_num_rows($user);
					 ?>" data-speed="8000"></h3>
              ...
              <div class="panel-body">
                <div class="row main-chart-parent">
				 <?php
					...
					{
						$res=mysql_query("select * from tbl_order_detail where product_id='".$row["product_id"]."'");
						$strXML .= "<set label='".$row["product_name"]."' value='".mysql_num_rows($res)."' />";
					}
					$strXML .= "</chart>";	
              ...
              <div class="panel-body">
                <div class="row main-chart-parent">
				 <?php
					...
					$sql=mysql_query("select * from tbl_employee");
					while($row=mysql_fetch_array($sql))
					{
						$res=mysql_query("select * from tbl_ticket where emp_id='".$row["emp_id"]."' and status='completed'");
						$strXML .= "<set label='".$row["emp_name"]."' value='".mysql_num_rows($res)."' />";
					}
					$strXML .= "</chart>";	
					//Create the chart - Column 3D Chart with data from strXML variable using dataXML method
              ...
              <div class="panel-body">
                <div class="row main-chart-parent">
				 <?php
					...
					while($row=mysql_fetch_array($sql))
					{
						$res=mysql_query("select * from tbl_ticket where emp_id='".$row["emp_id"]."' and status='assign'");
						$strXML .= "<set label='".$row["emp_name"]."' value='".mysql_num_rows($res)."' />";
					}
					$strXML .= "</chart>";	
					//Create the chart - Column 3D Chart with data from strXML variable using dataXML method
