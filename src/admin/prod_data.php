...
if (isset($_POST["hfAction"]) && $_POST["hfAction"] != "") {
    ...
    if ($_POST["hfAction"] == "add") {
        ...
        if ($id == "") {
            ...
            $sql = "update tbl_products set subcat_id='".mysql_real_escape_string($_REQUEST['txtsubcatname'])."',product_name='" . mysql_real_escape_string($_REQUEST["txtprodname"]) . "',description='" . mysql_real_escape_string($_REQUEST["txtproddes"]) . "',prod_img1='" . $filename1 . "',prod_img2='" . $filename2 . "',prod_img3='" . $filename3 . "',instruction='" . $filename . "',product_code='" . mysql_real_escape_string($_REQUEST["txtprodcode"]) . "',price='" . mysql_real_escape_string($_REQUEST["txtprice"]) . "',availibility='" . mysql_real_escape_string($_REQUEST["r_aval"]) . "' where product_id='" . $id . "'";
        }
    ...
    if ($action == "getdata") {
        ...
        $id = $mydata[0]->id;
        $img = mysql_query("select prod_img1,prod_img2,prod_img3 from tbl_products where product_id='" . $id . "'");
