              ...
              <div class="panel-body">
                <div class="row main-chart-parent">
				 <?php
					...
					while($row=mysql_fetch_array($sql))
					{
						$res=mysql_query("select * from tbl_ticket where emp_id='".$row["emp_id"]."'");
            ...
            <div class="panel panel-piluku">
              ...
              <div class="panel-body">
				...
				<?php
					...
					while($row=mysql_fetch_array($sql))
					{
						$res=mysql_query("select * from tbl_ticket where emp_id='".$row["emp_id"]."' and status='completed' and ticket_date BETWEEN '".$sdate."' AND '".$edate."'");
						$strXML .= "<set label='".$row["emp_name"]."' value='".mysql_num_rows($res)."' />";
					}
					$strXML .= "</chart>";	
					//Create the chart - Column 3D Chart with data from strXML variable using dataXML method
              ...
              <div class="panel-body">
                <div class="row main-chart-parent">
				 <?php
					...
					while($row=mysql_fetch_array($sql))
					{
						$res=mysql_query("select * from tbl_ticket where emp_id='".$row["emp_id"]."' and status='switch'");
						$strXML .= "<set label='".$row["emp_name"]."' value='".mysql_num_rows($res)."' />";
					}
					$strXML .= "</chart>";	
					//Create the chart - Column 3D Chart with data from strXML variable using dataXML method
